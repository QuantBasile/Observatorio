...
class DataModel:
    ...
    def __init__(self):
        ...
        # Optional extra filter (e.g. quick buttons like "next 7 days")
        # Signature: fn(df: pd.DataFrame) -> pd.DataFrame
        self._quick_filter_fn = None
        self._quick_filter_label: str = ""
    ...
    def set_df(self, df: pd.DataFrame):
        ...
        self.global_search = ""
        self._quick_filter_fn = None
        self._quick_filter_label = ""
        self.apply_filters()

    def set_quick_filter(self, fn, label: str = ""):
        """Set an extra filtering function applied after column + global search."""
        self._quick_filter_fn = fn
        self._quick_filter_label = label or ""
        self.apply_filters()
    ...
    def quick_filter_label(self) -> str:
        return self._quick_filter_label
    ...
    def apply_filters(self):
        ...
        # Quick filter (range filters etc.)
        if self._quick_filter_fn is not None:
            try:
                df = self._quick_filter_fn(df)
            except Exception:
                # Fail-safe: do not break the UI
                pass
