...
def get_default_actions() -> list[ActionSpec]:
    from .action_01 import run as action_1
    from .action_02 import run as action_2
    from .action_03 import run as action_3
    from .action_04 import run as action_4
    from .action_05 import run as action_5
    from .action_spread_matrix import run as action_spread_matrix
    from .action_issuer_plot import table as action_issuer_plot_table
    ...
    return [
        ...
        ActionSpec("action6", "Spread Matrix", "Matrix", "Spread Matrix", action_spread_matrix, "spread_matrix"),
